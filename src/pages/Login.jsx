...
const Login = () => {
  ...
  return (
  <section className="flex justify-center px-5 lg:px-0">
    <div className="w-full max-w-[570px] mx-auto rounded-lg shadow-md p-5 md:p-10">
      <h3 className="text-headingColor text-[22px] leading-9 font-bold mb-10">
        Hello! <span className="text-[#28B463]">Welcome</span> Back 🎉
      </h3>
      <form className="py-4 md:py-0" onSubmit={submitHandler}>
          ...
          <p className="mt-5 text-textColor text-center">
            ...
            <Link to='/register' className="text-[#28B463] font-medium ml-1">
              Register
            </Link> 
          </p>
      </form>
